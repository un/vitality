          ...
          {payload.map((item, index) => {
            ...
            return (
              <div
                key={item.dataKey}
                className={cn(
                  "flex w-full flex-wrap items-stretch gap-4 [&>svg]:h-2.5 [&>svg]:w-2.5 [&>svg]:text-neutral-500 dark:[&>svg]:text-neutral-400",
                  ...
                  <>
                    ...
                    >
                      ...
                      <div className="flex flex-row gap-0.5">
                        {item.value && (
                          <span className="font-mono font-medium tabular-nums text-slate-12">
                            {item.value.toLocaleString()}
                          </span>
                        )}
                        {item.unit && (
                          <span className="font-mono font-medium tabular-nums text-slate-11">
                            {item.unit}
                          </span>
                        )}
                      </div>
