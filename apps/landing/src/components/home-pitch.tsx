      ...
      {showPitch && (
        <div className="flex flex-col gap-4 ml-8 border-l-2 border-slate-9 pl-4 bg-slate-1 rounded-lg rounded-l-none italic text-sm">
          ...
          <p>
            ...
            you need to take a charging break before getting to your
            destination.
          </p>
          <p>
            ...
            now. And you might think you&apos;re on the right path heading in
            the right direction, but you missed a fork in the road and ended up
            going east instead of north.
          </p>
          <p>
