      ...
      {showPitch && (
        <div className="flex flex-col gap-4 ml-8 border-l-2 border-slate-9 pl-4 bg-slate-1 rounded-lg rounded-l-none italic text-sm">
          <p>
            ...
            very strict turns, and if you got lost it could mean driving around
            for hours till you find a point on the map before continuing.
          </p>
          <p>
          ...
          <p>
            The same was true of personal development. Thousands of books will
            tell you a rough route of how to get somewhere. But cant show you
            the exact route because they don&apos;t know where you are now. And
            you might think you&apos;re on the right path heading in the right
            direction, but you missed a fork in the road and ended up going
          ...
          <p>
            ...
            sure you have enough re-charging stops to get you there.
          </p>
        </div>
      )}
    </>
